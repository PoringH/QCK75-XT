...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_75_ansi(
		...
		KC_F19, KC_F20, KC_LSFT, KC_Z,	 KC_X, 	 KC_C, 	KC_V, 	KC_B, 	KC_N, 	KC_M, 	 KC_COMM, KC_DOT, 	KC_SLSH, KC_LSFT, 		   KC_UP, 	KC_PGDN, 
		KC_F21, KC_F22, KC_LCTL, KC_LGUI, KC_LALT, 						KC_SPC, 				  KC_LALT,	KC_NO,	 KC_LCTL, KC_LEFT, KC_DOWN, KC_RGHT
    )
};
